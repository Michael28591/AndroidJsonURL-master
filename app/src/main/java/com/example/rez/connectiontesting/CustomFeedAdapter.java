...
/**
 * Created by rmadabadi on 5/20/2016.
 */
public class CustomFeedAdapter extends ArrayAdapter<Feed> {

    public CustomFeedAdapter(Context context, Feed[] objects) {
        super(context, R.layout.feed, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customFeedView = myInflator.inflate(R.layout.feed, parent, false);
        ...
        //Get our widgets
        TextView myText = (TextView) customFeedView.findViewById(R.id.textView);
        ImageView myImage = (ImageView) customFeedView.findViewById(R.id.imageView);
